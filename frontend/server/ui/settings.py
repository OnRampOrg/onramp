...
# BASE_DIR = '/home/nick/onramp/dockerApp/server/'

STATIC_ROOT = os.path.join(BASE_DIR, 'ui', 'static', 'static_deployment')
STATICFILES_DIRS = (os.path.join(BASE_DIR, 'ui', 'static', 'static_resources'),)
STATIC_URL = '/static/'
